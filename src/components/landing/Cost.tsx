        ...
        <div className="w-full space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {costs.map((item, index) => (
              <div key={index} className="bg-white rounded-lg border border-gray-400 p-6 md:p-8 flex flex-col items-center justify-center text-center transition-shadow duration-300 min-h-40">
