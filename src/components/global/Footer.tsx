...
const Footer = () => {
  ...
  return (
    <footer className="bg-white py-12 px-4 md:px-20 border-t border-gray-200" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      <div className="container mx-auto">
        {/* Logos */}
        <div className="flex flex-col gap-4 mb-8">
          <img src={LogoGila} alt="Kampus Gila Marketing" className="h-auto w-28 md:w-36" />
          <img src={LogoMahardhika} alt="STIE Mahardhika" className="h-auto w-60 md:w-72" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-700 transition-transform transform hover:scale-110 active:scale-95">
