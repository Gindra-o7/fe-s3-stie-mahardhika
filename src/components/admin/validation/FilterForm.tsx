...
const FilterForm = ({ onSubmit }: FilterFormProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
      <h2 className="text-lg md:text-xl font-bold text-gray-900 uppercase tracking-wide mb-6">Data Pendaftar</h2>
      ...
      <div className="flex justify-end mt-8">
        <button onClick={handleSubmit} className="bg-[#08C9EC] hover:bg-[#06a8c6] text-white font-semibold py-2.5 px-8 rounded-lg transition-colors duration-200 text-sm cursor-pointer shadow-sm hover:shadow-md">
          Lihat
        </button>
      </div>
    </div>
